...
#import "AMXcodeHelper.h"

@implementation AMXcodeHelper
...
+ (IDESourceCodeDocument *)currentSourceCodeDocument {
    if ([[AMXcodeHelper currentEditor] isKindOfClass:NSClassFromString(@"IDESourceCodeEditor")]) {
        IDESourceCodeEditor *editor = [AMXcodeHelper currentEditor];
        return editor.sourceCodeDocument;
    }
    
    if ([[AMXcodeHelper currentEditor] isKindOfClass:NSClassFromString(@"IDESourceCodeComparisonEditor")]) {
        IDESourceCodeComparisonEditor *editor = [AMXcodeHelper currentEditor];
